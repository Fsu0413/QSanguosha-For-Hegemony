    ...
    general_name(general_name), skill_name(skill_name), rect(rect)
{
    ...
    generalPixmap->load("image/animate/blank.png", QSize(1000, 550), false);
    generalPixmap->setTransformOriginPoint(generalPixmap->boundingRect().width() / 2, generalPixmap->boundingRect().height() / 2);
    QString dir = QString("image/animate/%1.png").arg(general_name);
    generalPixmap->load(QFile::exists(dir)? dir : "image/animate/blank.png", QSize(1000, 550), false);
